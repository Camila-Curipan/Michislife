        ...
        <div class="card-body">
            ...
            {include file="../partials/_messages.tpl"}
               <!-- <form action="{$_layoutParams.root}{$process}" method="post">
                    ...
                    <input type="text" name="nombre" value="{$proveedore.nombre|default:""}" class="form-control" id="proveedore" aria-describedby="categoria">
                ...
                {include file="../proveedores/_form.tpl"}
