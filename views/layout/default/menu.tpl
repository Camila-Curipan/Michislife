<div id="ttl"> Michi's Life</div>
<div class="imgGatito">
    {html_image file="{$_layoutParams.route_img}gato1.jpg"}
</div>
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">

    <a class="navbar-brand" href="{$_layoutParams.root}">  
    <svg id="Capa_2" data-name="Capa 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800.01 666.67">
    <defs>
      <style>
        .cls-1 {
          fill: #fff;
